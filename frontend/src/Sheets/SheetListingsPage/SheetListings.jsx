                ...
                {sheets.map(sheet => (
                    <div key={sheet.id}>
                        ...
                        >
                            ...
                            <i
                                className="fa-solid fa-trash absolute top-4 right-4 cursor-pointer hover:text-red-500 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
