...
function Spellcasting({ draft, setDraft }) {
        ...
        for (let i = 0; i < maxSlotsPerLevel[index + 1]; i++) {
            markers.push(<Checkbox
                    ...
                    sx={{
                        ...
                        marginRight: -1,
                        color: grey400,
                        visibility: index + 1 > maxSpellLevel ? "hidden" : "visible",
    ...
    return (<div className='w-full bg-white rounded shadow p-2 flex flex-col items-center space-y-2'>
        <div className='text-4xl font-semibold'>Spellcasting</div>
        ...
        <div className='flex flex-col w-full items-center space-y-2'>
            ...
            <div className='grid w-full grid-cols-3 place-items-center mt-2'>
                {Array.from({ length: 9 }, (_, index) => (
                    <div className=' flex border-1 border-zinc-400 w-42 px-4 py-2 rounded items-center space-x-4 mb-2' key={index}>
