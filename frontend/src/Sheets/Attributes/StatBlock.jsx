    ...
    return (
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-4">
            <div className="flex flex-col md:mr-8 items-center  flex-shrink-0">
                <label className="mb-2 text-3xl font-semibold z-10" style={{color: '#1a1a1a'}}>{label}</label>
                <input
                    type="text"
                    placeholder={label}
                ...
                <div className="w-12 md:w-16 h-8 text-center border-2 font-semibold text-lg md:text-xl rounded-lg mt-1" style={{borderColor: '#db7f3d', backgroundColor: '#edeae8', color: '#1a1a1a'}}>
                    {GetModOfStat()}
                </div>
            </div>
